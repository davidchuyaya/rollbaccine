...
config_names = ["ROLLBACCINE", "NIMBLE_HDFS_100", "NIMBLE_HDFS_1"]
...
colors = ['orange', 'blue', 'purple']  # Different colors for configurations
...
plt.legend()
plt.tight_layout()
plt.savefig("../../../../results/graphs/nimble_hdfs_throughput_comparison.pdf")
