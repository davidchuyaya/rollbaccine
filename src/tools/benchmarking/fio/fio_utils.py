...
class FioBenchmark(Benchmark):
    def get_fio_commands(self, system_type: System):
        if system_type == System.UNREPLICATED:
            return [
                # Rand read, buffered
                ('read', 'rand', 0, 0, 1, False),
                ('read', 'rand', 0, 0, 4, False),
                ('read', 'rand', 0, 0, 8, False),
                ('read', 'rand', 0, 0, 16, False),
                ('read', 'rand', 0, 0, 32, False),
                # Rand read, direct
                ('read', 'rand', 1, 0, 1, False),
                ('read', 'rand', 1, 0, 4, False),
                ('read', 'rand', 1, 0, 8, False),
                ('read', 'rand', 1, 0, 16, False),
                ('read', 'rand', 1, 0, 32, False),
                # Read, buffered
                ('read', '', 0, 0, 1, False),
                ('read', '', 0, 0, 4, False),
                ('read', '', 0, 0, 6, False),
                ...
                ('read', '', 1, 0, 32, False),
                # Rand write, buffered
                ('write', 'rand', 0, 0, 1, False),
                ('write', 'rand', 0, 0, 4, False),
                # Rand write, direct
                ('write', 'rand', 1, 0, 1, False),
                ('write', 'rand', 1, 0, 4, False),
                ('write', 'rand', 1, 0, 8, False),
                ('write', 'rand', 1, 0, 16, False),
                ('write', 'rand', 1, 0, 32, False),
                # Write, buffered
                ('write', '', 0, 0, 1, False),
                ('write', '', 0, 0, 4, False),
                ('write', '', 0, 0, 8, False),
                ...
                ('write', 'rand', 0, 1, 1, False),
                ('write', 'rand', 0, 1, 4, False),
                ('write', 'rand', 0, 1, 8, False),
                ('write', 'rand', 0, 1, 16, False),
                ('write', 'rand', 0, 1, 32, False),
                # Rand write, fsync, direct
                ('write', 'rand', 1, 1, 1, False),
                ('write', 'rand', 1, 1, 4, False),
                ('write', 'rand', 1, 1, 8, False),
                ('write', 'rand', 1, 1, 16, False),
                ('write', 'rand', 1, 1, 32, False),
                ...
                ('write', '', 1, 1, 16, False),
                ('write', '', 1, 1, 32, False),
                # Write, direct, high contention
                ('write', '', 1, 0, 1, True),
                ('write', '', 1, 0, 4, True),
                ('write', '', 1, 0, 8, True),
                ('write', '', 1, 0, 16, True),
                ('write', '', 1, 0, 32, True),
                # Read, direct, high contention
                ('read', '', 1, 0, 1, True),
                ('read', '', 1, 0, 4, True),
                ('read', '', 1, 0, 8, True),
                ('read', '', 1, 0, 16, True),
            ...
            return [
                ...
                ('write', '', 0, 1, 256, False),
                ('write', '', 0, 1, 512, False),
                ('write', '', 0, 1, 1024, False),
                ('write', '', 0, 1, 2048, False),
                # Write, fsync, direct
                ('write', '', 1, 1, 1, False),
                ('write', '', 1, 1, 4, False),
                ('write', '', 1, 1, 8, False),
            ...
            return [
                ...
                ('write', 'rand', 1, 1, 32, False),
                ('write', 'rand', 1, 1, 64, False),
                ('write', 'rand', 1, 1, 128, False),
                ('write', 'rand', 1, 1, 256, False),
                # Write, fsync, buffered
                ('write', '', 0, 1, 1, False),
                ('write', '', 0, 1, 4, False),
                ('write', '', 0, 1, 8, False),
    ...
    def build_fio_commands(self, system_type: System, mount_point: str, output_dir: str, extra_args: str, iteration: int):
        ...
        for io_direction, sequentiality, direct, fsync, num_jobs, high_contention in all_combinations:
            rw = sequentiality + io_direction

            high_contention_job_name = 'contention' if high_contention else ''
            # Force write to same initial 4k of the mount point
            high_contention_param = '--size=4k' if high_contention else ''

            job_name = f"{system_type}_{rw}_direct{direct}_fsync{fsync}_{high_contention_job_name}_threads_{num_jobs}_{extra_args}"
